...
// HTTP 500 з ораклівським «literal does not match format string».
...
// Відколи з'явився ІСЦ (inflation.go), розходження вже тристороннє:
// exchange хоче YYYYMMDD, аукціони DD.MM.YYYY, ІСЦ — YYYYMM.
//
