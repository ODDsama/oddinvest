...
//
// Розкладка (allocate.go) відповідає на «ось 32 000 ₴ — розклади
...
// гроші, у яких є вибір, а обовʼязкове вибором не є (allocate.go,
// блок боргу).
//
...
func (c *routeCarry) enterMonth(m int, plans map[string]*state.MonthPlan,
	...
	// allocate.go). Борг у проході й далі тане за ГРАФІКОМ, вище.
