...
func (s *Server) handleSnapshots(w http.ResponseWriter, r *http.Request) {
	...
	// відсотки. Валютні частки тут парою, бо їх і читають парою.
	//
	// Частка EUR приходить із сентинелом: −1 бп у рядку, старшому за
	// колонку (0061), стає −0.01 після ділення й означає «тоді не
	// рахували», а не «−0.01 %». Розрізняти це — робота споживача, і
	// обидва наявні (таблиця «Як росте» й «Підсумок місяця») питають про
	// знак. Затирати сентинел тут не можна: нуль — законна частка.
