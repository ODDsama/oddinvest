...
// відповідь whatif.
//
// /api/plan/buys/check немає, і причина тепер інша, ніж була. Доти вона
// звучала «на це вже відповідає basket.shorts», і той вказівник повис
// разом із самою нестачею. Справжня причина глибша: питання «чи
