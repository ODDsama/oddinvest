...
// Поповнення резерву — ОКРЕМИЙ блок НАД ранжованим списком, а не рядок у
// ньому, і це не питання верстки.
//
...
//
// Тому питання розведені: цей блок відповідає на «скільки з цих грошей
// узагалі НЕ йде в папір», список нижче — на «що купити з решти».
//
