...
//
// Черга рахується в бекенді (internal/engine/state_tasks.go) і приходить
...
const ACTIONS = {
  ...
  // Ціль у задачі названа сумою, а не id, тож вести можна лише в спільне
  // місце: панель «Записати нове» несе форму нової цілі, а рухи під уже
  ...
  // правдою), борг — до журналу рухів. Доти обидві дії мапи не мали
  // зовсім, і задачі «сплати картку» стояли в черзі без кнопки.
  "pay-card": { to: "plan/debts/reconcile", label: "Звірити картку" },
  "pay-debt": { to: "plan/debts/journal", label: "Записати платіж" },
