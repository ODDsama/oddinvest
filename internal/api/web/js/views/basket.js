 ...
 *  свою причину лише наполовину.
 *
 *  Причина була така: «Огляд» відповідає на одне питання одним поглядом, і
 *  порожня рамка на ньому лише заважає. Для картки серед інших карток це
 *  досі правда. Але в кошика тепер є ВЛАСНА адреса, а сторінка, на яку
 *  можна прийти за посиланням і побачити білий екран, — зламана. Тому
 *  порожній стан малює той, хто кличе: тут лишається порожньо, а на
 *  #/now/basket стоїть пояснення, звідки беруться рядки. */
