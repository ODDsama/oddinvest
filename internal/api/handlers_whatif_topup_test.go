...
// engine/state_rebalance.go). Обидва відповідають на те саме питання власника:
...
// внесене» (engine/state_month.go), тож зі звичайною зарплатою залишок чесно
...
//
// Шапка engine/state_rebalance.go обіцяла її й доти, але обіцяла про ЦІЛІ:
