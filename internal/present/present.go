...
//	                          дохідності у валюті звітності), сусід обнуляється
...
// ruler — поле бере значення названого сусіда, сусід обнуляється. Лише
// при валюті ≠ книжкової: у гривні обидві лінійки лишаються, як були.
