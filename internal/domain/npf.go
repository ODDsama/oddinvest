...
// NPFCreditByAccount — ОЦІНКА податкової знижки на внески за рік, у
// мінорних одиницях.
//
...
// сплачене, а не дарує.
//
// Оцінка — на ПЛАТНИКА: місячний ліміт діє на СУМУ внесків усіх рахунків (і всіх фондів — закон рахує
