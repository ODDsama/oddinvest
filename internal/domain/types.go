...
type Position struct {
	...
	// гроші відомі з самого лота, а номінал, дата погашення й графік
	// виплат — ні, тож вони лишаються порожні. Прапорець потрібен, щоб
	// UI не видавав ці нулі за справжні.
	Unknown bool
}
