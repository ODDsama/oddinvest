...
type Doc struct {
	...
	// погашення.
	//
	// Самих боргів, стану картки й плану погашення тут НЕМАЄ — вони REST
	// (/api/debts, /api/payoff). Довід повністю — у шапці state_debts.go;
	// найкоротше: документ їде в MQTT і в щоденний знімок, тобто описує те,
	// що Є, а стан картки живе годинами й старіє між звірками.
